...
def salvar_resultado_teste_supabase(
    ...
    """
    Salva um resultado de teste na tabela resultados_granulometria.
    ...
    try:
        ...
        registro = {
            ...
            "percentual_bolhas_maiores_500_um": payload.get(
                "percentual_bolhas_maiores_500_um"
            ),
        ...
        resp = supabase.table("resultados_granulometria").insert(registro).execute()
